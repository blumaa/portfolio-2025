...
const backgroundVariants = {
  on: { backgroundColor: "#f5f5dc" }, // Beige/cream when light is on
  off: { backgroundColor: "#1a1a1a" }, // Dark when light is off
};
...
const AnimatedLamp = () => {
  const [lampOn, setLampOn] = useState(false); // Start with lamp off
  return (
    <Box
      as={motion.div}
