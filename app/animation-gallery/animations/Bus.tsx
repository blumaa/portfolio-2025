...
export default function Bus() {
  ...
  useGSAP(
    () => {
      ...
      [cloud1Ref, cloud2Ref, cloud3Ref, cloud4Ref].forEach(
        (cloudRef, index) => {
        ...
        <g fill={colorScheme === "dark" ? "#1E8449" : "#239B56"} opacity="0.6">
          ...
          {[
            ...
            return (
              <g
                key={`far-${i}`}
                transform={`translate(${x}, ${1500 + yOffset})`}
              >
                <path
          ...
          {/* Mid grass (medium) */}
          {[
            120, 270, 390, 540, 690, 820, 970, 1110, 1260, 1420, 1580, 1720,
            1860,
          ].map((x, i) => {
            ...
            return (
              <g
                key={`mid-${i}`}
                transform={`translate(${x}, ${1550 + yOffset})`}
              >
                <path
                  d={`M 0 0 Q -${curve} -${height1 * 0.5} 0 -${height1}`}
                  stroke={colorScheme === "dark" ? "#1E8449" : "#239B56"}
          ...
          {[
            40, 160, 310, 460, 580, 750, 890, 1050, 1190, 1350, 1490, 1640,
            1790, 1940,
          ].map((x, i) => {
            ...
            return (
              <g
                key={`near-${i}`}
                transform={`translate(${x}, ${1620 + yOffset})`}
              >
                <path
                  d={`M 0 0 Q -${curve} -${height1 * 0.5} 0 -${height1}`}
                  stroke={colorScheme === "dark" ? "#1E8449" : "#239B56"}
