    ...
    >
      ...
      <g ref={paperRef} transform="translate(300, 805) rotate(-8)">
        ...
        */}
        ...
        <polygon
          points="-37,-70 37,-70 52,70 -52,70"
          fill="#f5f5f5"
        />
      ...
      <g>
        ...
        <g transform="rotate(15 310 570)">
          ...
          <ellipse cx="285" cy="745" rx="10" ry="25" fill="#5b9bd5" transform="rotate(-15 285 745)" />
          <ellipse cx="302" cy="750" rx="10" ry="28" fill="#5b9bd5" />
          <ellipse cx="318" cy="750" rx="10" ry="28" fill="#5b9bd5" />
          <ellipse cx="335" cy="745" rx="10" ry="25" fill="#5b9bd5" transform="rotate(15 335 745)" />
          {/* Thumb - on right side of left hand */}
          <ellipse cx="340" cy="735" rx="12" ry="22" fill="#5b9bd5" transform="rotate(110 340 735)" />
        </g>
        ...
        <g transform="rotate(-15 490 570)">
          ...
          {/* Fingers - larger and more distinct */}
          <ellipse cx="465" cy="745" rx="10" ry="25" fill="#5b9bd5" transform="rotate(-15 465 745)" />
          <ellipse cx="482" cy="750" rx="10" ry="28" fill="#5b9bd5" />
          <ellipse cx="498" cy="750" rx="10" ry="28" fill="#5b9bd5" />
          <ellipse cx="515" cy="745" rx="10" ry="25" fill="#5b9bd5" transform="rotate(15 515 745)" />
          {/* Thumb - on left side of right hand */}
          <ellipse cx="460" cy="735" rx="12" ry="22" fill="#5b9bd5" transform="rotate(-110 460 735)" />
        </g>
      </g>
      ...
      >
        ...
        <path
          d="M 55 835 L 70 825 L 70 865 L 55 855 Z"
          fill="#3a3a3a"
        />
