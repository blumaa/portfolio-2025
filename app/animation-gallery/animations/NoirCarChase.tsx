...
export default function NoirCarChase() {
  ...
  useGSAP(
    () => {
      ...
      if (leadFrontWheel && leadBackWheel && chaseFrontWheel && chaseBackWheel) {
        gsap.to(
          [leadFrontWheel, leadBackWheel, chaseFrontWheel, chaseBackWheel],
          {
            rotation: 360,
            duration: 2,
            ease: "none",
    ...
    >
      ...
      <g ref={streetLampsRef}>
        {[0, 1, 2, 3, 4, 5, 6, 7].map((i) => (
          <g key={i} transform={`translate(${200 + i * 350}, 0)`}>
            ...
            {/* Lamp head */}
            <path
              d="M -20 600 L -30 580 L 30 580 L 20 600 Z"
              fill="#2a2a2a"
            />
            {/* Lamp glow */}
            ...
            {/* Light beam down */}
            <path
              d="M -15 600 L -30 700 L 30 700 L 15 600 Z"
              fill="#d4a349"
              opacity="0.15"
            />
          </g>
      ...
      <g ref={leadCarRef} transform="scale(2)">
        ...
        <g ref={leadHeadlightsRef}>
          <path
            d="M 70 -8 L 200 -15 L 200 15 L 70 8 Z"
            fill="url(#headlight)"
            opacity="0.7"
          />
        </g>
        ...
        <g>
          ...
          {/* Roof/cabin */}
          <path
            d="M -40 -15 L -30 -35 L 30 -35 L 40 -15 Z"
            fill="#0f0f0f"
          />
          {/* Windows - noir style dark */}
          <path
            d="M -38 -16 L -30 -32 L -5 -32 L -5 -16 Z"
            fill="#2a2a2a"
          />
      ...
      <g ref={chaseCarRef} transform="scale(2)">
        ...
        <g>
          ...
          {/* Windows */}
          <path
            d="M -36 -16 L -28 -28 L -5 -28 L -5 -16 Z"
            fill="#3a3a3a"
          />
          ...
          <ellipse ref={copLightRef} cx="0" cy="-32" rx="8" ry="4" fill="#ff0000" opacity="0.9" />
        </g>
