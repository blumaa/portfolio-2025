...
export default function RustlingGrass() {
  ...
  return (
    ...
    >
      ...
      <path className="blade" fill={grassColor} d="m 88.56,522.90302 c -0.32,0.5526 -0.78,0.921 -1.42,1.41987 -2.25,-1.69616 -4.33,-3.5228 -6.41,-5.34944 0.23,-0.19955 0.46,-0.3991 0.69,-0.59865 2.34,1.44289 4.67,2.89346 7.14,4.52822 z" />
